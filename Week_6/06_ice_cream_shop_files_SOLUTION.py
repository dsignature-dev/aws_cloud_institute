"""
Refer to the model solution from Week 3.  Implement additional functionality
...
# import json to convert order dicts to JSON objects
from datetime import datetime
import json

# programattically create file name with current date
today = datetime.now()
orders_file_name = today.strftime("orders_%Y%m%d.txt")

""" Start of order taker program """
...
""" End of order taker program """

# Open the file in append mode
orders_file = open(orders_file_name, "a")
